...
function getTZISO(){const off=-new Date().getTimezoneOffset(),sign=off>=0?"+":"-",abs=Math.abs(off),h=String(Math.floor(abs/60)).padStart(2,"0"),m=String(abs%60).padStart(2,"0");return sign+h+":"+m}
